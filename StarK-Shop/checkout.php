   ...
   <h3>Your Orders</h3>
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <input type="text" name="name" placeholder="MASUKKAN NAMAMU" class="box" maxlength="20" required>
         </div>
         <div class="inputBox">
            <span>NO HANDPHONE :</span>
            <input type="number" name="number" placeholder="MASUKKAN NOMORMU" class="box" min="0" max="9999999999" onkeypress="if(this.value.length == 10) return false;" required>
         </div>
         <div class="inputBox">
            <span>EMAIL :</span>
            <input type="email" name="email" placeholder="MASUKKAN EMAILMU" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            ...
            <select name="method" class="box" required>
               ...
               <option value="paytm">Bank BNI</option>
         ...
         <div class="inputBox">
            <span>KOTA :</span>
            <input type="text" name="city" placeholder="MALANG" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>PROVINSI:</span>
